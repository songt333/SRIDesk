...
DEF("video", HAS_ARG, QEMU_OPTION_video,
    "-video WxH Set video resolution\n",
    QEMU_ARCH_ALL)
STEXI
@item -video @var{width}x@var{height}
@findex -video
Set video resolution.
ETEXI

DEF("vdev", HAS_ARG, QEMU_OPTION_vdev,
    "-vdev dev	Set virtual video device\n",
    QEMU_ARCH_ALL)
STEXI
@item -vdev @var{dev}
@findex -bios
Set virtual video device.
ETEXI
